...
\descript{| SymPy }
\location{April 22 - Aug 23, 2016}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Worked on computational group theory.
\item Created capability to do computation with Finite Groups and Finitely Presented Groups.
\item Representing Finitely Presented Groups, free groups, semi group, free semigroup, and other group related algebraic structures.
\item Respective algorithms for the computation of Normailizers, Centeralizer, Center, Order, Subgroups, Orbit etc.
\end{tightemize}
\sectionsep
