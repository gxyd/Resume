...
\location{2013 - 2018 \\ GPA: 7.343/10}
\sectionsep
...
\section{Open Source}
    \textbullet{} \href{https://github.com/lfortran/lfortran}{\custombold{LFortran}} \textbullet{} \href{https://github.com/sympy/sympy}{\custombold{SymPy}} \textbullet{} \href{https://fluxml.ai/Flux.jl}{\custombold{Flux}} \textbullet{} \href{http://scikit-learn.org/}{\custombold{scikit-learn}} \textbullet{} \href{http://mpmath.org/}{\custombold{mpmath}}
...
\location{Competent:}
\textbullet{} Kotlin \textbullet{} BASH \\
\location{Familiar:}
\textbullet{} Julia \textbullet{} MongoDB \\
\subsection{Operating System}
\textbullet{} macOS \textbullet{} GNU/Linux
\subsection{Tools \& Framework}
\textbullet{} Visual Studio Code \textbullet{} Git
\sectionsep
...
\runsubsection{LFORTRAN}
\descript{| Compiler Engineer }
\location{Remote | March 2024 - June 2025}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\vspace{\topsep}
\begin{tightemize}
\item Making LFortran, a modern open-source Fortran compiler built on top of LLVM, reach beta stage
\item Improve array operation ASR (internal compiler representation) pass functionality
\item Tech stack: C++, LLVM C++ API
\end{tightemize}
\sectionsep

\runsubsection{Digital Aristotle (later BYJU's)}
\descript{| Senior Research Engineer }
\location{Bangalore, India | April 2022 - Feb 2024}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\runsubsection{Digital Aristotle}
\descript{| Junior Research Engineer }
\location{Bangalore, India | June 2018 - March 2022}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\vspace{\topsep}
\begin{tightemize}
...
\location{September and December 2017, February 2018}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\vspace{\topsep}
\begin{tightemize}
...
% \runsubsection{Julia ecosystem for machine learning}
% \descript{| Open Source}
% \location{since September, 2020}
% \vspace{\topsep}
% Contributing to few open source machine learning and differentiable programming libraries written in Julia. For ex.
% \href{https://github.com/FluxML/Flux.jl}{\custombold{Flux}}, \href{https://github.com/FluxML/Zygote.jl}{\custombold{Zygote}}
% and \href{https://github.com/JuliaDiff/ChainRules.jl}{\custombold{ChainRules}}
% \sectionsep
